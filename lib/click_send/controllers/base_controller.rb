  ...
  class BaseController
    ...
    def validate_response(context)
      if context.response.status_code == 400
        raise APIException.new "400 - BAD_REQUEST", context
        ...
        raise APIException.new "404 - NOT_FOUND", context
      elsif context.response.status_code == 405
        raise APIException.new "405 - METHOD_NOT_FOUND", context
      elsif context.response.status_code == 429
        raise APIException.new "429 - TOO_MANY_REQUESTS", context
      elsif context.response.status_code == 500
        raise APIException.new "500 - INTERNAL_SERVER_ERROR", context
