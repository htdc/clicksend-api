...
module ClickSend
  class Subaccount < BaseModel
    ...
    def self.names
      if @hash.nil?
        @hash = {}
        @hash["api_username"] = "api_username"
        @hash["password"] = "password"
        @hash["email"] = "email"
        @hash["phone_number"] = "phone_number"
        @hash["first_name"] = "first_name"
        @hash["last_name"] = "last_name"
        @hash["access_users"] = "access_users"
        @hash["access_billing"] = "access_billing"
        @hash["access_reporting"] = "access_reporting"
        @hash["access_contacts"] = "access_contacts"
        @hash["access_settings"] = "access_settings"
      end
      @hash
    end
