...
module ClickSend
  class ReferralAccount < BaseModel
    ...
    def self.names
      if @hash.nil?
        @hash = {}
        @hash["referral_rule_id"] = "referral_rule_id"
        @hash["refered_user_id"] = "refered_user_id"
        @hash["date_referred"] = "date_referred"
        @hash["percentage_referral"] = "percentage_referral"
      end
      @hash
    end
